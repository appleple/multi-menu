...
var defaultOption = {
    ...
    linkOnToggle: false,
    prependHTML: function (link) { return "<li><a href=\"#\" class=\"js-menu-back-btn\">\u2190 Back </a></li>"; },
    appendHTML: function (link) { return "<span class=\"multi-menu-arrow\"></span>"; },
    levelLimit: Infinity,
};
var MultiMenu = /** @class */ (function () {
    ...
    MultiMenu.prototype.flattenList = function (uls) {
        var _this = this;
        [].forEach.call(uls, function (ul) {
            if (utility_1.hasClass(ul, _this.opt.flattenedClass)) {
                return;
            }
            if (ul.previousElementSibling && ul.previousElementSibling.dataset) {
                ul.previousElementSibling.dataset.ulId = ul.dataset.id;
                utility_1.append(ul.previousElementSibling, _this.opt.appendHTML(ul.previousElementSibling));
            }
            ...
            utility_1.addClass(ul, _this.opt.flattenedClass);
        });
    };
    MultiMenu.prototype.backLink = function (link) {
        ...
        if (parentId) {
            ...
            [].forEach.call(targetUls, function (targetUl) {
                utility_1.removeClass(targetUl, _this.opt.activeMenuClass);
            });
            ...
            setTimeout(function () {
                utility_1.addClass(parentUl_1, _this.opt.activeMenuClass);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = link.getAttribute(this.opt.fetchAttribute);
                        if (!url) {
                            return [2 /*return*/];
                        }
            ...
            if (link.dataset.ulId === targetUl.dataset.id || targetUl === ul) {
                ...
                setTimeout(function () {
                    if (link.dataset.ulId === targetUl.dataset.id) {
                        utility_1.addClass(targetUl, _this.opt.activeMenuClass);
                    }
                }, 100);
    ...
    MultiMenu.prototype.setLink = function (link) {
        ...
        link.addEventListener('click', function (e) {
            // @ts-ignore
            if (!_this.opt.linkOnToggle || (!link.href || !e.target.dataset.ulId)) {
                e.preventDefault();
    ...
    MultiMenu.prototype.setActiveMenu = function () {
        ...
        if (!activeUl) {
            if (newUls && newUls[0]) {
                utility_1.addClass(newUls[0], this.opt.activeMenuClass);
            }
            return;
        }
        var targetUls = this.multiMenu.querySelectorAll('ul');
